...
namespace BusinessLogicalLayer
{
    internal class FuncionarioConstants
    {
        ...
        public const string MENSAGEM_ERRO_CPF_COMPRIMENTO = $"CPF deve conter 11 caracteres";
        ...
        public const string MENSAGEM_ERRO_EMAIL_COMPRIMENTO_MINIMO = $"Email não pode conter menos que 5 caracteres.";
        public const string MENSAGEM_ERRO_EMAIL_COMPRIMENTO_MAXIMO = $"Email não pode conter mais que 100 caracteres.";
