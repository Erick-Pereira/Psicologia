...
namespace VisualLayer.Controllers
{
    public class HomeController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            {
                id = Convert.ToInt32(_httpContextAccessor.HttpContext.User.Claims.FirstOrDefault(f => f.Type == ClaimTypes.Sid).Value.Decrypt("ID"));
        ...
        public async Task Logar(Entities.Funcionario funcionario)
        {
            ...
            claims.Add(new Claim(ClaimTypes.Sid, funcionario.ID.ToString().Encrypt("ID")));
            ...
            claims.Add(new Claim(ClaimTypes.Role, funcionario.Cargo.Funcao));
        ...
        {
            Entities.Funcionario funcionario = _FuncionarioService.GetByID(Convert.ToInt32(_httpContextAccessor.HttpContext.User.Claims.FirstOrDefault(f => f.Type == ClaimTypes.Sid).Value.Decrypt("ID"))).Result.Item;
